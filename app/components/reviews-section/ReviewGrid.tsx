...
const Reviews = () => {
    ...
    return (
        <section
            ...
            <motion.div
                className="grid w-[90%] max-w-[1345px] grid-cols-1 place-content-center place-items-center gap-x-6 gap-y-6 sm:grid-cols-2  sm:grid-rows-3 lg:grid-cols-3 lg:grid-rows-1">
