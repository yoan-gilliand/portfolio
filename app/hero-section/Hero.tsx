  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex items-center gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
          ...
          >
            <FontAwesomeIcon icon={faGithub}
                             className="h-full w-auto text-[24px] sm:text-[32px] md:text-[36px] lg:text-[40px]"/>
          </Link>
          <Link
